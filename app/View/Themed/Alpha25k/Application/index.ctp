                    ...
                    <div class="row" style="margin-top:20px;">
                        ...
                        <div class="col-sm-12">
                            <div class="ckbox ckbox-success">
                                ...
                                By checking the box, I agree by electronic signature to be contacted by Winshiplending, participating lenders, and/or  <a href="https://global.leadstudio.com/thirdparty" data-title="Third Party" data-toggle="lightbox" data-gallery="remoteload">Third Parties</a> about financial services and credit related offers by a live agent, artificial or prerecorded voice, and SMS text at my residential or cellular number (<span id = "offer_phone"></span>), dialed manually or by auto dialer, even if I have previously indicated my preference of “do not call” with a government registry (consent to be contacted is not a condition to purchase services; consent can be revoked at any time).
                                </label>
                            </div>
                        </div>
                      </div>
